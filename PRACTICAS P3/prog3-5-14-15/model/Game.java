...
public class Game {
	...
	/**
	 * moveCurrentPieceDown(): mueve la pieza actual a abajo si no está fija, el lugar está vacío, el lugar es válido y la pieza no está fija y borra las filas que están llenas, devolviendo cuantas de ellas borra cada vez.
	 * 
	 * @throws NoCurrentPieceException
	 *             no pieza
	 * @throws GameEndedMovementException
	 ...
	 * @throws FixedPieceMovementException
	 *             pieza fija
	 * @return devuelve el número de filas borradas en este movimiento
	 */
