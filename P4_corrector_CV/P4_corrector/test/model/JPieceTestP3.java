...
public class JPieceTestP3 {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		coorD0.add(new Coordinate(0,0));
		coorD270.add(new Coordinate(0,2));
		coorD180.add(new Coordinate(2,2));
		coorD90.add(new Coordinate(2,0));
