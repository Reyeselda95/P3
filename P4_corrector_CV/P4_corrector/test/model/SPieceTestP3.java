...
public class SPieceTestP3 {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		symbol = '▦';
		for (int i=0; i < 2; i++) {
			coorD0.add(new Coordinate(0,i+1));
			coorD0.add(new Coordinate(1,i));
			coorD270.add(new Coordinate(i,1));
			coorD270.add(new Coordinate(i+1,2));
			coorD180.add(new Coordinate(1,i+1));
			coorD180.add(new Coordinate(2,i));
			coorD90.add(new Coordinate(i,0));
			coorD90.add(new Coordinate(i+1,1));
		}
