...
public class TPieceTestP3 {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		for (int i=0; i<3; i++) {
			for (int j=0; j<3; j++)	{
				if (i==0) {
					coorD0.add(new Coordinate(i,1));
					coorD270.add(new Coordinate(i,1));
					coorD90.add(new Coordinate(i,1));
				}
				if (i==1) {
					switch (j){
						case 1: coorD270.add(new Coordinate(i,j));
